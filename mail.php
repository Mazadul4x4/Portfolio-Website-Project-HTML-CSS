...
if ($name == "") {
    ...
    $headers .= 'From:  inbio <mazadul4x4@gmail.com>' . "\r\n";
    $headers .= 'cc: mazadul4x4@gmail.com' . "\r\n";
    $headers .= 'bcc: mazadul4x4@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f mazadul4x4@gmail.com');
